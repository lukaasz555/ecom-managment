import { AccountActivationEmailOptions } from './activate-account.options';

export class ActivateAccountStrategy {
  generateTemplate(payload: AccountActivationEmailOptions): string {
    return `
    <!DOCTYPE html>
      <html lang="en">
        <head>
